				...
				<c:if test="${not empty USERMODEL}">
					...
					<ul class="dropdown" id="userOption">
						...
						<li><a href="<c:url value = "/capnhat?page=info"/>">Đổi
								thông tin</a></li>
						<li><a href="<c:url value = "/view/web/list-order.jsp"/>">Đơn
								hàng</a></li>
								...
								<div class="cart-hover">
													...
													<tr class="row${details.id}">
														...
														<td class="si-text">
															<div class="product-selected">
																<div style="font-size: 15px">
																	...
																	x <span id="quan2${details.id}">${details.quantity}</span>
																</div>
														...
														<td class="si-close">
															<button class="deleteBtn"
																style="background-color: #fff; outline: none; border: none;"
																type="submit">
																<i class="ti-close"></i>
															</button>
														</td>
									...
									<div class="select-button">
										<a href="<c:url value="/gio-hang"/>"
											class="primary-btn view-card">Giỏ hàng</a> <a href="#"
				...
				<ul>
					...
					<li class="pages"><a>Trang</a>
						<ul class="dropdown">
							...
							<li class="pages"><a
								href="<c:url value = "/view/web/feedback.jsp"/>">Góp ý</a></li>
						</ul></li>
				</ul>
			</nav>
