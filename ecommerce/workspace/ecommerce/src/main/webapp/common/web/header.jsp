                ...
                <div class="lan-selector">
                    <select class="language_drop" name="countries" id="countries"
                        ...
                        <option value='yt'
                                ...
                                data-imagecss="flag yt" data-title="Việt Nam">VietNam
                        </option>
                        <option value='yu'
                                data-image="<c:url value="/template/img/flag-2.jpg"/>"
                                data-imagecss="flag yu" data-title="English">English
                        </option>
                    </select>
                </div>
                            ...
                            <c:if test="${(not empty CART) and (CART.cartDetailsList.size() != 0)}">
                                <div class="cart-hover">
                                        ...
                                        <table>
                                            ...
                                            <c:forEach items="${CART.cartDetailsList}" var="details">
                                                <tr class="row${details.stock.id}">
                                                    ...
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <div style="font-size: 15px"><fmt:formatNumber
                                                                ...
                                                                x
                                                                <span id="quan2${details.stock.id}">
                                                    ...
                                                    <td class="si-close">
                                                        <button detail-id="${details.stock.id}"
                                                                class="deleteBtn" type="button"
                                                                style="outline: none; border: none;background-color: #fff;">
                                                            <i class="ti-close"></i>
                                                        </button>
                                                    </td>
                                    ...
                                    <div class="select-button">
                                        <a href="<c:url value="/gio-hang"/>" class="primary-btn view-card">Giỏ
                                            hàng</a>
                        ...
                        <ul class="dropdown">
                            <c:forEach items="${listPromotion}" var="promotion">
                                <li class="sale-page"><a
                                        href="<c:url value = "/sale?id=${promotion.id}"/>"> ${promotion.name}</a></li>
                            </c:forEach>
