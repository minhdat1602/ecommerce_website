...
<aside class="left-sidebar bg-sidebar">
	<div id="sidebar" class="sidebar sidebar-with-footer">
		<!-- Aplication Brand -->
		<div class="app-brand">
			<a href="<c:url value ="/admin/index.jsp"/>"> <svg class="brand-icon"
			...
			<ul class="nav sidebar-inner" id="sidebar-menu">
				...
				<li class="has-sub active expand"><a class="sidenav-item-link"
					...
					<ul class="collapse show" id="dashboard"
						...
						<div class="sub-menu">
							...
							<li><a class="sidenav-item-link" href='<c:url value ="/view/admin/product/list-product.jsp"/>'> <span
									class="nav-text">Sản phẩm</span>

							</a></li>


							<li><a class="sidenav-item-link" href="<c:url value ="/view/admin/order/list-order.jsp"/>">
				...
				<li class="has-sub"><a class="sidenav-item-link"
					...
					aria-controls="ui-elements"> <i
						...
						class="nav-text">UI Elements</span> <b class="caret"></b>
				</a>
				...
				<li class="has-sub"><a class="sidenav-item-link"
					...
					<ul class="collapse" id="charts" data-parent="#sidebar-menu">
						<div class="sub-menu">
							...
							<li><a class="sidenav-item-link" href="chartjs.html"> <span
									class="nav-text">ChartJS</span>
