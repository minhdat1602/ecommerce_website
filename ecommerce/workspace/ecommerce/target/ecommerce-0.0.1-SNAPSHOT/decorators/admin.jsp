...
<body class="sidebar-fixed sidebar-dark header-light header-fixed"
	...
	<script src="<c:url value="/template/admin/assets/plugins/toaster/toastr.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/slimscrollbar/jquery.slimscroll.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/charts/Chart.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/ladda/spin.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/ladda/ladda.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/jquery-mask-input/jquery.mask.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/select2/js/select2.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/jvectormap/jquery-jvectormap-world-mill.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/daterangepicker/moment.min.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/daterangepicker/daterangepicker.js" />"></script>
	<script src="<c:url value="/template/admin/assets/plugins/jekyll-search.min.js" />"></script>
